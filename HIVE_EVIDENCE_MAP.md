...
| EXP-REF-MODEL-TESTS | Deterministic tests at this revision | Authority, replay, contradiction, compression, ablation, versioning, rollback, registry invariants | Executable formal coherence | Empirical learning or cognition |
...
Decompression --SUPPORTED/solver-relative--> Solver
Solver/Reconstruction --IMPLEMENTED--> Evaluation
...
| Minimum sufficient representation | SUPPORTED conditionally | frozen essential/control ablation plus exact reference ablator | grouped interactions, alternative minima, robustness/transfer |
...
The exploratory Codex result supports:

> On the frozen synthetic worlds, the engineered compressed packet retained enough causal, temporal, and authority information for that capable solver stack to answer every case while receiving materially less state/context.
