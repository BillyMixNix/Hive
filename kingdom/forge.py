...
class HiveCapabilityAuthor:
    """Ask Hive for a tiny pure-function capability plus executable examples."""
    ...
    def author(self, target: Any, request: ToolRequest) -> CapabilityCandidate | None:
        prompt = (
            ...
            f"Provide 1-{self.max_cases} executable examples that demonstrate the intended contract. "
...
class CapabilityForge:
    """Author -> policy -> RegressionGate -> isolated runtime -> Arena registration."""
