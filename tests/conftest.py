...
def _mock_ask_model(prompt, model=None, timeout=120):
...
def _ask_hive(prompt, role="default", timeout=None, model=None):
    return _mock_ask_model(prompt, model=model, timeout=timeout)
